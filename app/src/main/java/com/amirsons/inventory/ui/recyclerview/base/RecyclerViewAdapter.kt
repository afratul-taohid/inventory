 ...
 */
abstract class RecyclerViewAdapter<T, L : BaseRecyclerClickListener<T>>(private val items: ArrayList<T> = ArrayList()) : RecyclerView.Adapter<BaseRecyclerViewHolder<T, L>>() {
    ...
    /**
     * Update item to selected index of the data set.
     * Notifies that item has been updated.
     * @param item item which has to be update to the adapter.
     */
